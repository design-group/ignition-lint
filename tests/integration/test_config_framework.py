...
def create_sample_test_configs():
	...
	# NamePatternRule tests (updated from ComponentNameRule)
	name_pattern_config = {
		"test_suite_name": "NamePatternRule Tests",
		"description": "Test cases for naming conventions",
		"test_cases": [{
			"name": "pascal_case_components_positive",
			"description": "PascalCase view should pass PascalCase component rule",
			...
			"tags": ["naming", "pascal_case", "positive", "components"]
		}, {
			"name": "camel_case_components_negative_pascal",
			"description": "camelCase view should fail PascalCase component rule",
			...
			"tags": ["naming", "pascal_case", "negative", "components"]
		}, {
			"name": "camel_case_components_positive",
			"description": "camelCase view should pass camelCase component rule",
			"view_file": "camelCase/view.json",
			"rule_config": {
				"NamePatternRule": {
					"enabled": True,
			...
			"tags": ["naming", "camel_case", "positive", "components"]
		}, {
			"name": "snake_case_components_positive",
			"description": "snake_case view should pass snake_case component rule",
			...
			"tags": ["naming", "snake_case", "positive", "components"]
		}, {
			"name": "mixed_node_types_standard_conventions",
			"description": "Standard conventions: PascalCase components, camelCase properties",
			"view_file": "PascalCase/view.json",
			"rule_config": {
				"NamePatternRule": {
					"enabled": True,
			...
			"tags": ["naming", "mixed_types", "standard_conventions", "positive"]
		}, {
			"name": "inconsistent_case_negative",
			"description": "inconsistentCase view should fail any strict naming rule",
			...
			"tags": ["naming", "inconsistent", "negative", "components"]
		}]
	}
	...
	configs = [("name_pattern_tests.json", name_pattern_config),
